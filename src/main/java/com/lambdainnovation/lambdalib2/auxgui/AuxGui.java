package com.lambdainnovation.lambdalib2.auxgui;
...
public abstract class AuxGui {
    ...
    // Parameters
    /**
     * Whether this AuxGui needs fixed timestamp update (ticking). If set to true onTick() method will get called each onTick.
     */
