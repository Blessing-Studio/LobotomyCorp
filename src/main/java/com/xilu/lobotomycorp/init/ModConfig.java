...
//        @Config.LangKey("lobotomycorp.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "lobotomycorp.msg.welcome";
    }

    @Config.LangKey("configgui.lobotomycorp.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.lobotomycorp.category.Menu0.SpawnConf")
