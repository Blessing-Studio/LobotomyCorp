package com.xilu.lobotomycorp.recipe.special;

import javax.annotation.Nonnull;

import com.xilu.lobotomycorp.item.goblet.ItemP2WGoblet;
	...
	public ItemStack getCraftingResult(@Nonnull InventoryCrafting var1) {
		...
		for(int i = 0; i < var1.getSizeInventory(); i++) {
			...
			if(!stack.isEmpty()) {
				...
				//LobotomyCorp.Log(stack.getItem().getUnlocalizedName() + " vs " + ItemBlock.getItemFromBlock(Blocks.GOLD_BLOCK).getUnlocalizedName());
			}
		}
