package com.xilu.lobotomycorp.entity.projectiles;
...
public class EntityIdlProjectile extends Entity implements IProjectile {
    ...
    protected EntityIdlProjectile(World worldIn, ProjectileArgs args) {
        super(worldIn);
        this.args = args;
        //LobotomyCorp.Log("bullet created %s, args = %s", getUniqueID(), this.args);
    }
...
//    }
    ...
    {
        //LobotomyCorp.Log("Bullet pos update:%s", getPositionEyes(0));
    ...
    protected boolean isFireballFiery()
    {
        if (args == null)
        {
            //LobotomyCorp.LogWarning("Args not found for bullet");
            return false;
        }
        return args.burning;
    }
...
//    }
    ...
    {
        //LobotomyCorp.Log("bullet impact %s", getUniqueID());
