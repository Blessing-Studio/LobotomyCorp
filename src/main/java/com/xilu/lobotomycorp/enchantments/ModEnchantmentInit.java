package com.xilu.lobotomycorp.enchantments;
...
public class ModEnchantmentInit {
    ...
    public static final ModEnchantmentBase PHYSICAL_DAMAGE = new ModEnchantmentBase("lobotomycorp.physical_damage", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand);
    public static final ModEnchantmentBase MENTAL_DAMAGE = new ModEnchantmentBase("lobotomycorp.mental_damage", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand);
    public static final ModEnchantmentBase EROSION_DAMAGE = new ModEnchantmentBase("lobotomycorp.erosion_damage", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand);
    public static final ModEnchantmentBase SPIRIT_DAMAGE = new ModEnchantmentBase("lobotomycorp.spirit_damage", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand);
    //Example Enchant
//    public static final ModEnchantmentBase ANTI_VANILLA = new ModEnchantmentBase("lobotomycorp.anti_vanilla", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand)
