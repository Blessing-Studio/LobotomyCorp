package com.xilu.lobotomycorp.item.misc.armor;

import java.util.List;

import com.xilu.lobotomycorp.item.IGuaEnhance;
import com.xilu.lobotomycorp.item.ItemArmorBase;
...
public class ItemArmorXieGeta extends ItemArmorBase implements IGuaEnhance {
    ...
    public static void onCreatureHurt(LivingHurtEvent evt) {
        if (evt.isCanceled() || evt.getSource() != DamageSource.FALL) {
            //LobotomyCorp.Log("Xie Geta wrong type");
            return;
        }
        ...
        if (onFoot.getItem() instanceof ItemArmorXieGeta)
        {
            ...
            //LobotomyCorp.Log("Xie Geta dmg reduction:%s", reduction);
