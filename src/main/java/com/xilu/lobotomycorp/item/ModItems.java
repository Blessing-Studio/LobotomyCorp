...
public class ModItems {
	...
	public static final Item LC_PEBOX = new ItemBase("lc_item_pebox").setCreativeTab(ModCreativeTab.LC_ITEM);
...
//            "lobotomycorp:armor_moroon", "lobotomycorp:armor_moroon", 80, new int[] {3, 6, 8, 3}, 2, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 2)
