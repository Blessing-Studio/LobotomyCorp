package com.blessingstudio.lobotomycorp.components.data;
...
public class NbtData {
    ...
    public static final String NAME_OFF= "lobotomycorp.shared.off";
    public static final String NAME_ON= "lobotomycorp.shared.on";
    ...
    //gua socket
    public static final String GUA_NO_FREE_SOCKET_DESC = "lobotomycorp.gua_enhance_no_free.desc";
    public static final String GUA_FREE_SOCKET_DESC = "lobotomycorp.gua_enhance_free.desc";
    public static final String GUA_TOTAL_SOCKET_DESC = "lobotomycorp.gua_enhance_total.desc";
    public static final String GUA_N_A_DESC = "lobotomycorp.gua_not_applicable.desc";
    ...
    public static final String KILL_COUNT_DESC = "lobotomycorp.kill_count.desc";
