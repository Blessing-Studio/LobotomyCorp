...
public class CustomNbtData {
    ...
    public CustomNbtData(NBTTagCompound srcNBT) {
    ...
    public void readFromBasic(NBTTagCompound tag) {
        if (tag != null) {
            pearlCount = tag.getInteger(NbtData.LEVEL_TAG);
            isEarth = tag.getBoolean(NbtData.IS_EARTH);
            isSky = tag.getBoolean(NbtData.IS_SKY);
        }
    }
    ...
    public void writeToBasic(NBTTagCompound tag) {
        ...
        tag.setInteger(NbtData.LEVEL_TAG, pearlCount);
        tag.setBoolean(NbtData.IS_EARTH, isEarth);
        tag.setBoolean(NbtData.IS_SKY, isSky);
    }
    ...
    public static NBTTagCompound getPlyrIdlTagSafe(EntityPlayer player) {
        ...
        NBTTagCompound idl_data = getTagSafe(data, NbtData.IDEALLAND);
    ...
    public static void setPlayerIdeallandTagSafe(EntityPlayer player, String key, int value) {
        ...
        data.setTag(NbtData.IDEALLAND, idl_data);
